...
<br />
<div align="center">
  <a href="https://github.com/hermitdesu/WordleBot/wordleBotLogo.png">
...
2. Clone the repo
   ```sh
   git clone https://github.com/hermitdesu/WordleBot.git
   ```
...
5. Change git remote url to avoid accidental pushes to base project
   ```sh
   git remote set-url origin hermitdesu/WordleBot
